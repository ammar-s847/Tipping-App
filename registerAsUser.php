    ...
    <body>
        ...
        <form class="form-signup" action="php/signup.script.php" method="post">
            <div class="container">
                ...
                <input type="text" placeholder="FULL NAME" name="user-signup-name" required>
                ...
                <button type="submit" name="user-signup-submit" class="btn btn-primary btn-lg finalbtn">Submit</button>
